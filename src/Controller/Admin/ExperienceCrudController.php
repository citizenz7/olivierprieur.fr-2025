...
class ExperienceCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setPageTitle('index', 'Liste des expériences')
            ->setPageTitle('edit', 'Modifier une expérience')
            ->setPageTitle('new', 'Ajouter une expérience')
            ->setPageTitle('detail', 'Expérience')
    ...
    public function configureActions(Actions $actions): Actions{
        return $actions
            ...
            ->update(Crud::PAGE_INDEX,Action::NEW,function(Action $action){
                return $action->setIcon('fas fa-newspaper pe-1')->setLabel('Ajouter une expérience');
            })
